...
using NostedServicePro.MVC.Models.Account;
...
namespace NostedServicePro.MVC.Controllers
{
    public class AccountController : Controller
    {
       ...
       // private readonly IEmailSender _emailSender;
        ...
        public AccountController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, ILoggerFactory loggerFactory, IUserRepository userRepository)
        {
